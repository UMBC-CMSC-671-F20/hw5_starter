;; Block A is on the table, block B is on A, and there is nothing on B.  A
;; water bucket, a brush, a can of red paint, and a can of blue paint
;; are on the table and all are clear.  The goal is to for A to be colored red
...
(define (problem p2)
  ...
  (:goal (and (arm-empty)(on b a)(color a red)(on-table a)(color b blue)(clean brush1))))
